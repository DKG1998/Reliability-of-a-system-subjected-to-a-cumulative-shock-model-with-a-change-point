---
title: "Reliability of a system subjected to a cumulative shock model with a change point"
author: "Dheeraj Goyal and Arnab Hazra"
output: pdf_document
---
...
plot(t_values, rel_values, type = "l", col = "blue", lty = 1, lwd = 2.3,
     ...
     cex.main = 1.1, cex.lab = 1.1, cex.axis = 1.1, bty = "n",
...
plot(M_values, err_rel_1, col = "blue", lty = 1, lwd = 2.5,
     ...
     ylim = c(0, 0.20), cex.main = 1.1, cex.lab = 1.1, cex.axis = 1.1, bty = "n",
...
legend("topright", legend = c(expression(lambda == 1),
                              expression(lambda == 2),
                              expression(lambda == 3)),
       col = c("blue", "red", "black"), lty = c(1, 2, 3), lwd = 2.2, bty = "n", cex = 1.1)
```
...
legend("topright", legend = c(expression(L[1]),
                              expression(L[2])),
       col = c("blue", "red"), lty = c(1, 2), lwd = 2.2, bty = "n", cex = 1.1)
```
